# TokenHub Electron Desktop App

This directory contains the Electron wrapper for TokenHub, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/TokenHub/data/`
  - Windows: `%APPDATA%/TokenHub/data/`
  - Linux: `~/.config/TokenHub/data/`
